...
public class Demo01_30 {
	...
	private int createQuadProgram() throws IOException {
		...
		int vshader = createShader("30/quad.vert", GL_VERTEX_SHADER);
		int fshader = createShader("30/quad.frag", GL_FRAGMENT_SHADER);
	...
	private int createRayTracingProgram() throws IOException {
		...
		int vshader = createShader("30/quad.vert", GL_VERTEX_SHADER);
		int fshader = createShader("30/demo01_30.frag", GL_FRAGMENT_SHADER);
