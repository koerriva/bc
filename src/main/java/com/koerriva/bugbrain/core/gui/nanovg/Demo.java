...
public class Demo {
    ...
    private static final NVGGlyphPosition.Buffer glyphs    = NVGGlyphPosition.create(1000);
    private static final ByteBuffer              paragraph =
    memUTF8(
            "静夜思（唐.李白）\n床前明月光\n疑似地上霜\n举头望明月\n低头思故乡 " +
                    ".🎉",
                    false
    ...
    public static final FloatBuffer gpuTimes = BufferUtils.createFloatBuffer(3);
    ...
    public static int loadDemoData(long vg, DemoData data) {
        if (vg == NULL) {
            return -1;
        }
