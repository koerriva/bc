...
public class NanoVGUtils {
    ...
    public static void startGPUTimer(GPUtimer timer) {
        if (!timer.supported) {
            return;
        }
    ...
    public static void saveScreenShotGL(int w, int h, boolean premult, String name) {
    ...
    public static void unpremultiplyAlpha(ByteBuffer image, int w, int h, int stride) {
        int x, y;
